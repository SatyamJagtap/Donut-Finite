...
function draw() {
  ...
  textSize = 25;
  fill("red");
  text("Life = "+life,score3.x+25,score3.y+25);
  //bowl.debug = true;
  ...
  if(gamestate == "end"){
    //textSize(25);
    text("Game Over",score3.x,score3.y+50);
  }
  drawSprites();
}
function donut1(){
